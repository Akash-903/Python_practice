...
@st.cache_resource
def load_model():
    model = joblib.load("C:\Users\Ramesh\Desktop\COE\LogisticRegression\logistic_regression_model.pkl")
    return model

# Load the dataset to get feature names
@st.cache_resource
def load_data():
    df = pd.read_csv("C:\Users\Ramesh\Desktop\COE\heart.csv")
    return df
...
try:
    ...
    st.error(f"❌ Error: {e}")
    st.info("Make sure the model file is saved at: C:\Users\Ramesh\Desktop\COE\LogisticRegression\logistic_regression_model.pkl")
